...
%>       
       <tr align="center">
         ...
         <td nowrap="nowrap"><a href="<%=basePath%>admin/yy/yyinfo.jsp?roomid=<%=pagelist2.get(0).toString()%>">查看</a></td>
         <td nowrap="nowrap"><%if(pagelist2.get(6).toString().equals("空闲")){ %>
         <a href="<%=basePath%>admin/yy/add.jsp?method=yyroom&id=<%=pagelist2.get(0).toString()%>">借用</a><%}else{} %> 
         </td>
       </tr>
<% }} %>
       <tr align="center">
