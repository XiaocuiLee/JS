...
<div class="title_right"><strong>教室信息借用</strong></div>  
<div style="width:900px;margin:auto;">
<form action="<%=basePath %>ComServlet?method=<%=method%>&roomid=<%=id%>" method="post" name="form1" onSubmit="return check()">
<table class="table table-bordered"> 
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">教室名称：</td>
     <td width="60"><%=cb.getString("select mc from room where id='"+id+"'") %></td> 
     </tr>
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">使用时间：</td>
     <td width="60"><input type="date" name="sj" class="span4" /></td> 
     </tr>
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">借用用途：</td>
     <td width="60"><input type="text" name="zt" class="span4" /></td> 
     </tr>
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">上课人数：</td>
     <td width="60"><input type="text" name="rs" class="span4" /></td> 
     </tr> 
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">说明信息：</td>
     <td width="60"><textarea name="sm" class="span4" rows="5"></textarea></td> 
     </tr>  
     <tr>
