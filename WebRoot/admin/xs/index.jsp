...
<%
	...
	int cou = cb.getMessageCount("select count(*) from admin where sf='学生用户'");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from admin where sf='学生用户' order by id desc",9);
