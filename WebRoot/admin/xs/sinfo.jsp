...
<table class="table table-bordered table-striped table-hover">
     <tbody>
       <tr align="center">
         ...
         <td nowrap="nowrap"><strong>学生学号</strong></td>
...
<%  String word=Common.toChineseAndTrim(request.getParameter("word"));
	...
	int cou = cb.getMessageCount("select count(*) from admin where username like '%"+word+"%' and sf='学生用户' ");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from admin where username like '%"+word+"%' and sf='学生用户' order by id desc",9);
...
%>       
       <tr align="center">
         ...
         <td nowrap="nowrap"><a href="<%=basePath%>admin/xs/add.jsp?method=upxs&id=<%=pagelist2.get(0).toString()%>">编辑</a> 
