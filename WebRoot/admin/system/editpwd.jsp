...
<form action="<%=basePath %>AdminServlet?method=uppwd" method="post" name="form1" onSubmit="return check()">
<table class="table table-bordered">
	 <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">旧&nbsp;&nbsp;密&nbsp;&nbsp;码：</td>
     <td width="60"><input type="password" name="oldpwd" class="span3" /></td> 
     </tr>
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">新&nbsp;&nbsp;密&nbsp;&nbsp;码：</td>
     <td width="60"><input type="password" name="newpwd" class="span3" /></td> 
     </tr>
     <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">确认密码：</td>
     <td width="60"><input type="password" name="repwd" class="span3" /></td> 
     </tr>
     <tr>
